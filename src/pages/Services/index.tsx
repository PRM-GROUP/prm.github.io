      ...
      <div className='container'>
        ...
        <div className={styles.service__item}>
          ...
          <div id='baixo_relevo' className={styles.service__item__content}>
            ...
            <div className={styles.centerButton}>
              <Link className={styles.button} to="/gravacao-em-baixo-relevo">Conheça mais</Link>
            </div>
            <div className={styles.line}></div>
          </div>
        </div>
        ...
        <div id='dtf' className={styles.service__item}>
          <div className={styles.service__item__content__reverse}>
            ...
            <div className={styles.centerButton}>
              <Link className={styles.button} to="/dtf">Conheça mais</Link>
            </div>
        ...
        <div id='laser' className={styles.service__item}>
          ...
          <div className={styles.service__item__content}>
            ...
            <div className={styles.centerButton}>
              <Link className={styles.button} to="/gravacao-a-laser">Conheça mais</Link>
            </div>
        ...
        <div id='silk_screen' className={styles.service__item}>
          ...
          <div className={styles.service__item__content}>
            ...
            <div className={styles.centerButton}>
              <Link className={styles.button} to="/silk">Conheça mais</Link>
            </div>
        ...
        <div id='sublimacao' className={styles.service__item}>
          ...
          <div className={styles.service__item__content__reverse}>
            ...
            <div className={styles.centerButton}>
              <Link className={styles.button} to="/sublimacao">Conheça mais</Link>
            </div>            
        ...
        <div className={styles.service__item}>
          ...
          <div id='tampografia' className={styles.service__item__content}>
            ...
            <div className={styles.centerButton}>
              <Link className={styles.button} to="/tampografia">Conheça mais</Link>
            </div>
        ...
        <div id='transfer' className={styles.service__item}>
          ...
          <div className={styles.service__item__content__reverse}>
            ...
            <div className={styles.centerButton}>
              <Link className={styles.button} to="/transfer">Conheça mais</Link>
            </div>
        ...
        <div className={styles.service__item}>
          ...
          <div id='digital' className={styles.service__item__content}>
            ...
            <div className={styles.centerButton}>
              <Link className={styles.button} to="/digital">Conheça mais</Link>
            </div>
        ...
        <div id='digital360' className={styles.service__item}>
          ...
          <div className={styles.service__item__content__reverse}>
            ...
            <div className={styles.centerButton}>
              <Link className={styles.button} to="/digital360">Conheça mais</Link>
            </div>
