...
import ImgPresentation from "../../assets/APRESENTAÇÃO.jpg";
import ImgAboult from "../../assets/alboult.jpg";
      ...
      <section className={styles.main__PRW} id='prw_embalagens' ref={sectionsRef.prw_embalagens}>
        <div className={`${styles.container__prw} container`}>
          ...
          <div className={styles.text__prw}>
            ...
            <a className={styles.button}  href="https://prm-group.github.io/prw.github.io/#home" target="_blank">Conheça a PRW Embalagens</a>
          </div>
        </div>
      </section>
